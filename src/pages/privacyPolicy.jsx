...
import { Shield, Lock, Eye, UserCheck, Server, Bell, Settings, Trash } from "lucide-react";
        ...
        >
          ...
          >
            ...
            <p className="text-gray-700">
              For any questions about our privacy policy or to exercise your data rights, please contact us:
              <br /><br />
              Support: <span className="text-orange-600 font-semibold">support@damadash.com</span><br />
          ...
          >
            ...
            <p>You can request account deletion at any time through your account settings</p>
          </motion.div>
        </motion.div>
      </motion.div>
    </div>

...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Image */}
      <div className="hidden lg:flex justify-center lg:w-1/2 relative bg-blue-600">
        ...
        />
        <div className="relative flex flex-col justify-center items-center text-white p-8">
          <h1 className="text-4xl font-bold mb-6">Join Carry Ethiopia</h1>
          <p className="text-lg text-center max-w-md">
            Create an account and start experiencing hassle-free delivery services across Ethiopia.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSignUp} className="mt-8 space-y-6">
            ...
            <div>
              <button
                type="submit"
                className="group relative w-full flex justify-center py-3 px-4 border border-transparent rounded-lg text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-300"
              >
                Create Account
              </button>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="w-full flex justify-center items-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-300">
                Google
              </button>
              <button className="w-full flex justify-center items-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-300">
                Apple

  ...
  return (
    <div className="p-6 flex flex-col items-start space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 w-full">
        ...
        <div className="flex space-x-4">
          ...
          <div className="w-1/2">
            ...
            <div className="relative">
              <input type="number" className="p-3 border rounded w-full pl-8" />
        ...
        <div>
          <label className="text-sm text-gray-600">Address Sending From</label>
          <input type="text" className="p-3 border rounded w-full" />
        </div>

        <div>
          <label className="text-sm text-gray-600">Address Delivered To</label>
          <input type="text" className="p-3 border rounded w-full" />
        </div>
      ...
      <div className="flex flex-col items-start space-y-2 w-full">
        ...
        <span className="text-sm text-gray-500">XLS, TXT, PNG, JPEG, GIF</span>
      </div>

...
import { AlertTriangle, UserX, ArrowLeft, Phone, MessageSquare, CheckCircle, XCircle } from "lucide-react";
      ...
      >
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 lg:p-12 shadow-xl border border-orange-100">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900">Delete Account</h1>
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-xl p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-semibold text-gray-800">Please Note</h2>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-gray-700 leading-tight">
                  I understand that this action is permanent and cannot be undone. All my data will be permanently deleted from the platform.
                </span>
              </label>
            </div>
            ...
            <div className="flex gap-4 pt-4">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className={`px-6 py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-semibold text-lg transition-all duration-200 flex-1 flex items-center justify-center gap-2 ${isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
              >
                {isSubmitting ? (
                  <>
                    <motion.div
